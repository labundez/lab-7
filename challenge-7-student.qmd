...
summarized_fish <- fish |>
  group_by(year, species) |>
  summarise(total_condition_index = sum(condition_index, na.rm = TRUE), .groups = 'drop')


ggplot(summarized_fish, aes(x = year, y = total_condition_index, fill = species)) +
  geom_bar(stat = "identity", position = "stack") +
  labs(x = "Year",
       y = "Total Condition Index",
       subtitle = "Fish Condition Index by Species Over Time",
       fill = "Species") +
  theme_minimal()
```
